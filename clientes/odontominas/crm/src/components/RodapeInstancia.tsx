 ...
 * atualizar, anunciar, agendar, excluir); aqui só "editar apelido" e
 * "atualizar status" existem de verdade no sistema — desconectar/excluir
 * mexeriam no WhatsApp real da clínica (ação séria demais pra um botão sem
 * confirmação extra), e anunciar/agendar não são funcionalidades que
 * existem. Botão decorativo sem efeito é pior que não ter o botão.
 */
export function RodapeInstancia({ apelidoAtual }: { apelidoAtual: string | null }) {
